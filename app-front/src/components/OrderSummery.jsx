    ...
    return (
        <div className="shadow space-y-1 p-4 bg-white">
            <div className="space-y-2">
                ...
                <p className="text-lg font-bold text-amber-500">Precio: {formatCurrency(price)}</p>
                <p className="text-lg text-gray-700">Subtotal: {formatCurrency(price * qty)}</p>
            </div>

            <div className="flex justify-between gap-2 pb-4">
                <button type="button" className="bg-sky-700 p-2 text-white rounded-md font-bold uppercase shadow-md text-center">
